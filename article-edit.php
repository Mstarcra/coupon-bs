...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="acticle-list.php">
                    <i class="fa-solid fa-guitar"></i>
                    <span>文章管理</span></a>
            </li>
        ...
        <table class="table table-bordered">
            ...
            <tr>
                <th>ID</th>
                <td><input type="number" class="form-control" name="id" value="<?= $row["id"] ?>"></td>
            </tr>
            <tr>
                <th>標題</th>
            ...
            <tr>
                <th>內容</th>
                <td><textarea name="content" class="form-control" cols="100" rows="10" value="<?= $row["content"]; ?>"></textarea></td>
            </tr>
            <tr>
                <th>創建時間</th>
                <td><input type="datetime-local" class="form-control" name="created_time" value="<?= $row["created_time"]; ?>"></td>
            </tr>
            <tr>
                <th>更新時間</th>
                <td><input type="datetime-local" class="form-control" name="updated_time" value="<?= $row["updated_time"]; ?>"></td>
            </tr>
        </table>
